...
void main() {
  group('AdviceRemoteDataSource', () {
    group('Should return AdvbiceModel', () {
    ...
    group('Should throw', () {
      test('a ServerException when response was not 200', () async {
        final mockClient = MockClient();
      ...
      test('a Type error when cclient response was 200 and has no valid data', () async {
        final mockClient = MockClient();
